...
const ContactSection = () => {
    ...
    return (
        <>
            <Helmet>
                <title>تواصل معنا - دار الإتقان</title>
                <meta name="description" content="تواصل مع دار الإتقان لتعليم القرآن" />
            </Helmet>
                    ...
                    {isLoading ? (
                        ...
                        <div className="flex flex-col lg:flex-row gap-12 max-w-6xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
                            ...
                            <div className="lg:w-2/5 bg-green-600 p-8 text-white flex items-center">
                                <div className="space-y-8">
                                    <h2 className="text-2xl font-semibold mb-4">كن على تواصل دائمًا معنا</h2>
